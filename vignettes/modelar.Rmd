...
Cada arquivo de áudio `.wav` pode ser entendido como um vetor de inteiros. Cada componente do vetor indica a frequência em cada unidade de tempo.
...
- `som`: Frequência observada no instante de tempo.
